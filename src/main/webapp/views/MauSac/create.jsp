...
<body>
<div class="container">
    <h2 class="text-center text-secondary">MauSac</h2>
    <pr:form action="${action}" method="post" modelAttribute="ms">

        <div class="row">
            <div class="col-5">Mã CTSP:</div>
            <div class="col-5"><pr:input type="text" id="1" placeholder="Mã"  path="ma"/><span><pr:errors path="Ma" cssClass="text-danger"/></span></div>
        </div>
        <div class="row mt-3">
            <div class="col-5">Tên CTSP:</div>
