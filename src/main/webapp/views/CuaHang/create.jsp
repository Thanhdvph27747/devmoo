...
<pr:form action="${action}" method="post" modelAttribute="ch">
        ...
        <div class="row mt-3">
            ...
            <div class="col-5"><pr:input type="text" id="3" placeholder="Địa chỉ" path="diaChi"/><span id="loi3"></span></div>
        </div>
        <div class="row mt-3">
            <div class="col-5">Thành phố:</div>
            <div class="col-5"><pr:input type="text" id="4" placeholder="Thành phố" path="thanhPho"/><span id="loi4"></span></div>
        </div>
        <div class="row mt-3">
            <div class="col-5">Quốc gia:</div>
            <div class="col-5">
                <pr:select path="quocGia" id="5">
