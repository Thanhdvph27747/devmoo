...
<body>
<div class="container">
    <h2 class="text-center text-secondary">DongSP</h2>
    <pr:form action="${action}" method="post" modelAttribute="dongsp">

        <div class="row">
            <div class="col-5">Mã DongSP:</div>
            <div class="col-5"><pr:input type="text" id="1" placeholder="Mã"  path="ma"/><span><pr:errors path="Ma" cssClass="text-danger"/></span></div>
        </div>
        <div class="row mt-3">
            <div class="col-5">Tên DongSP:</div>
